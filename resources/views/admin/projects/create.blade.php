                            ...
                            <div x-show="card">
                                <div class="cxebx">
                                    <div>
                                        ...
                                        <input id="project-name" name="name" class="c03gb c3ff8 @error('name') border-red-500 @enderror" type="text" placeholder="Enter Name of the Project">
                                        @error('name')
                                    ...
                                    <div>
                                        ...
                                        <input id="prject-budget" name="budget" class="c03gb c3ff8 @error('budget') border-red-500 @enderror" type="number" placeholder="Budget">
                                        @error('budget')
                                            <span class="text-sm text-red-500">{{ $message }}</span>
                                        @enderror
                                    </div>
                                            ...
                                            <div id="feedback-modal" class="flex items-center justify-center ct1ew clpyc c1u8w citi2 cqfmf crf5v c9r0z" role="dialog" aria-modal="true" x-show="modalOpen" x-transition:enter="c5mjj cgpmj ch8aq" x-transition:enter-start="opacity-0 c8f6f" x-transition:enter-end="cqsra cfwq4" x-transition:leave="c5mjj cgpmj ch8aq" x-transition:leave-start="cqsra cfwq4" x-transition:leave-end="opacity-0 c8f6f" x-cloak="">
                                                <div class="bg-white dark:bg-slate-800 rounded cn60w craqh cetne c0nbw c3ff8" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                                    ...
                                                    <div class="cx95x ctysv">
                                                        <div class="text-sm">
                                                            <div class="text-slate-800 dark:text-slate-100 cw92y cvavu">Assign a partners to Your project</div>
                                                        </div>
                                                        <div class="cd0mw">
                                                            <div>
                                        ...
                                        <div x-data="{ modalOpen: false }" class="c9o7o">
                                            ...
                                            <div id="feedback-modal" class="flex items-center justify-center ct1ew clpyc c1u8w citi2 cqfmf crf5v c9r0z" role="dialog" aria-modal="true" x-show="modalOpen" x-transition:enter="c5mjj cgpmj ch8aq" x-transition:enter-start="opacity-0 c8f6f" x-transition:enter-end="cqsra cfwq4" x-transition:leave="c5mjj cgpmj ch8aq" x-transition:leave-start="cqsra cfwq4" x-transition:leave-end="opacity-0 c8f6f" x-cloak="">
                                                <div class="bg-white dark:bg-slate-800 rounded cn60w craqh cetne c0nbw c3ff8" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                                    ...
                                                    <div class="cx95x ctysv">
                                                        <div class="text-sm">
                                                            <div class="text-slate-800 dark:text-slate-100 cw92y cvavu">Assign artists to your project.</div>
                                                        </div>
                                                        <div class="cd0mw">
                                                            <div>
                                                                <label class="block text-sm cw92y ci4cg" for="name">Name</label>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="description" id="project-desc"  class="c03gb c3ff8 @error('description') border-red-500 @enderror" rows="4"></textarea>
                                        @error('description')
                                            <span class="text-sm text-red-500">{{ $message }}</span>
                                        @enderror
                                    </div>
