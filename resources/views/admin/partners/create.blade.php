                    ...
                    <div x-show="card">
                        <div class="cxebx">
                            ...
                            <div>
                                ...
                                <input id="name" name="name" class="c03gb c3ff8 @error('name') border-red-500 @enderror"  type="text" placeholder="Partner Name">
                                @error('name')
                            ...
                            <div>
                                ...
                                <textarea name="expertise" id="expertise" class="c03gb c3ff8 @error('expertise') border-red-500 @enderror" rows="6" placeholder="Add Parnter Expertise"></textarea>
                                @error('expertise')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
