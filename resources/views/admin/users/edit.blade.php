                ...
                <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="c3goj caod7">
                        ...
                        <section>
                            ...
                            <div class="cxbdy c95r9 cuga1 cxebx clk9r cggtb">
                                <div class="czb6y">
                                    ...
                                    <input id="username" name="username" class="c03gb c3ff8 @error('username') border-red-500 @enderror" type="text" placeholder="Username" value="{{ $user->username }}">
                                    @error('username')
                                ...
                                <div>
                                    ...
                                    <!-- Dropdown -->
                                    <div class="c4ijw" x-data="{ open: false, selected: {{ $user->roles->first()->id - 1 }} }">
                        ...
                        <section>
                            ...
                            <div class="cggtb">
                                <div class="czb6y">
                                    <input id="email" name="email" class="c03gb c3ff8 @error('email') border-red-500 @enderror" type="text" placeholder="user@artsy.com" value="{{ $user->email }}" readonly style="cursor: not-allowed;">
                                    @error('email')
                                    <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <!-- Phone -->
                        <section>
                            <h3 class="text-slate-800 dark:text-slate-100 font-bold ctbo0 cvvcr ci4cg">Phone</h3>
                            <div class="text-sm">Ensuring the accuracy of your phone number helps us maintain the security and integrity of your account.</div>
                            <div class="cggtb">
                                <div class="czb6y">
                                    <input name="phone" class="c03gb c3ff8 @error('phone') border-red-500 @enderror" type="phone" placeholder="Enter Your phone Number" value="{{ $user->phone }}">
                                    @error('phone')
                                    <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
